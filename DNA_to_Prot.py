...
# It test for equality between result generated by above functions and orignal sequence of amino acid present in file Protien.txt.

obj = open("Protiens.txt","r")
s=obj.read()
s=purify_seq(s)
if s==generate_protien_seq("DNA.txt"):
    print "Success : Sequence generated matches with the answer ie. Protien.txt file."
